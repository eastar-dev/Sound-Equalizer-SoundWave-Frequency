...
public class RealDoubleFFT extends RealDoubleFFT_Mixed {
	 ...
	 *            <em>x</em>[0]; its imaginary part
	 *            is 0. If <em>n</em> is even set <em>m</em> = <em>n</em>/2, if
	 *            <em>n</em> is odd set <em>m</em> = <em>n</em>/2, then for <br>
	 ...
	 *            If <em>n</em> is even,
	 *            the real of part of (<em>n</em>/2)-th complex FFT coeffients
	 *            is <em>x</em>[<em>n</em>]; its imaginary part is 0.
	 *            The remaining complex FFT coeffients can be obtained by the
	 *            symmetry relation:
	 *            the (<em>n</em>-<em>k</em>)-th complex FFT coeffient is the
	 *            conjugate of <em>n</em>-th complex FFT coeffient.
	 *
	 */
	 ...
	 *            (<em>n</em>/2+1) (when <em>n</em> is even) FFT coeffients.
	 *            The remaining complex FFT coeffients can be obtained by the
	 *            symmetry relation:
	 *            the (<em>n</em>-<em>k</em>)-th complex FFT coeffient is the
	 *            conjugate of <em>n</em>-th complex FFT coeffient.
	 ...
	 *            the comments of <em>ft</em>(double[])
	 *            for the relation between <em>x</em> and complex FFT
	 *            coeffients.
	 */
	 ...
	 *            <em>n</em> is odd, it contains the first
	 *            (<em>n</em>+1)/2 complex data; when <em>n</em> is even, it
	 *            contains (<em>n</em>/2+1) complex data.
	 * @param y
